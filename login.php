...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="issmenu.css">
    <style>
    body,
    html {
        height: 100%;
...
<body>
    ...
    <form method="post" class="lcontainer">
        ...
        <button style="float:right;" type="submit" name="submit" class="btn"><a href="signup.php"
                style="color: white;text-decoration: none">Sigup Here</a></button>
